...
<head>
    ...
    <title>CURICHAZO - Sistema de Ventas</title>
...
<body>
    ...
    <section class="stage">
        ...
        <nav class="navbar" id="navbar">
            <a class="brand" href="#">CURICHAZO</a>
        ...
        <div class="project-card">
            <div class="project-img-wrap">
                <video class="project-img" controls loop muted poster="<?php echo BASE_URL; ?>/public/image/poster1.jpg">
                    <source src="<?php echo BASE_URL; ?>/public/video/registro_ventas.mp4" type="video/mp4">
                </video>
            </div>
            <h3 class="project-title">Registro de ventas</h3>
            <p class="project-desc">Registro rápido y sencillo de ventas de Curichis y Marcianos. Sistema intuitivo para gestionar tus productos.</p>
        ...
        <div class="project-card">
            <div class="project-img-wrap">
                <video class="project-img" controls loop muted poster="<?php echo BASE_URL; ?>/public/image/poster2.jpg">
                    <source src="<?php echo BASE_URL; ?>/public/video/panel_productos.mp4" type="video/mp4">
                </video>
            </div>
            <h3 class="project-title">Panel de Productos</h3>
            <p class="project-desc">Gestiona tus Curichis y Marcianos: precios, stock, sabores. Todo desde un panel administrador.</p>
